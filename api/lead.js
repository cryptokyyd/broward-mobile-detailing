 ...
 *
 * Delivery lives in _deliver.js and is shared with voice.js, so a phone
 * lead and a web lead land in the same place. Every configured channel is
 * attempted; the lead is accepted if AT LEAST ONE succeeds:
...
import { deliver, escapeHtml } from './_deliver.js';
